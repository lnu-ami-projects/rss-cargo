// <copyright file="RSSHomeView.xaml.cs" company="RSSCargo">
...
namespace RSS_Cargo.Presentation.MVVM.View
{
    ...
    /// <summary>
    /// Interaction logic for RSSHomeView.xaml.
    /// </summary>
    public partial class RSSHomeView : UserControl
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RSSHomeView"/> class.
        /// </summary>
        public RSSHomeView()
        {
            ...
            for (int i = 0; i < Program.UserFeeds.Count; i++)
            {
                for (int j = 0; j < Program.UserFeeds[i].Items.Count(); j++)
                {
                    ...
                    var image = new Image
                    {
                        Height = 100,
                        Width = 100,
                        Source = new BitmapImage(new Uri("/Presentation/Images/streamlinehq-image-picture-flower-images-photography-100.png", UriKind.Relative)),
                    ...
                    this.allFeedsList.Children.Add(feedItemBtn);
                }
            }
        }
    }
